...
<script type="text/javascript">
	$('.select').change(function(){
		...
		time = '<span class="label" style="width: 40px; text-align:center">Start</span> \
			<input type="date" name="start_date[' + tid + ']" class="span4" /> \
			<input type="time" name="start_time[' + tid + ']" class="span4" /> \
			<br /> \
			<span class="label" style="width: 40px; text-align:center">End</span> \
			<input type="date" name="end_date[' + tid + ']" class="span4" /> \
			<input type="time" name="end_time[' + tid + ']" class="span4" />';
