<div class="contest_list">
	<table id="contest_table" class="table table-condensed table-bordered table-striped">
		<thead><tr><th class="cid">Contest ID</th><th id="title">Title</th><th>Mode</th><th>Start Time</th><th>Submit Time</th>
	...
	<?php
		foreach ($data as $row){
			...
			echo "<tr><td>$cid</td><td class=\"title\">" . 
				...
				"</td><td>$row->startTime</td><td>$row->submitTime</td><td>$row->endTime</td><td>$row->status</td><td>";
